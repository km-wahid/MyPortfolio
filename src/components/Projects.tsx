...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      tech: ['Django', 'Asterisk', 'WebSockets', 'OpenAI', 'PostgreSQL'],
      problem: 'Customer service agents couldn\'t handle volume during peak hours.',
      solution: 'AI-powered voice agent that integrates with existing call systems.',
      impact: 'Reduced wait times by 85% and successfully handled 70% of common inquiries.',
      github: 'Working',
      demo: '#',
      description: 'An AI voice agent system that integrates with Asterisk telephony platform. The system transcribes incoming calls in real-time, processes the text through an AI model to generate appropriate responses, and converts those responses back to speech for the caller. Includes a Django admin dashboard for call monitoring and intervention.',
    },
    {
      id: 4,
